...
/**
 * 鉴定收费减档基准线 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITJasFeeTierService {

    /** 按主键查询规则 */
    TJasFeeTier selectTJasFeeTierById(Long id);
    ...
    List<TJasFeeTier> listAvailable(Date at);

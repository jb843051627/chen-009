...
/**
 * 鉴定收费减档基准线对象 t_jas_fee_tier
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_jas_fee_tier")
@ApiModel(value = "TJasFeeTier", description = "鉴定收费减档基准线")
public class TJasFeeTier implements Serializable {
    ...
    @ApiModelProperty(value = "减档基准代号")
    private String ruleCode;

    /** 减档基准名称 */
    @TableField("rule_name")
    @ApiModelProperty(value = "减档基准名称")
    private String ruleName;

    /** 一档标的上限(元) */
    @TableField("th1_max")
    @ApiModelProperty(value = "一档标的上限(元)")
    private BigDecimal th1Max;

    /** 二档标的上限(元) */
    @TableField("th2_max")
    @ApiModelProperty(value = "二档标的上限(元)")
    private BigDecimal th2Max;

    /** 三档标的上限(元) */
    @TableField("th3_max")
    @ApiModelProperty(value = "三档标的上限(元)")
    private BigDecimal th3Max;

    /** 启用日 */
    @TableField("eff_start")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "启用日")
    private Date effStart;

    /** 交棒日(不含) */
    @TableField("eff_end")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "交棒日(不含)")
    private Date effEnd;
    ...
    /** 线的情形 0在用 1已让位 */
    @TableField("status")
    @ApiModelProperty(value = "线的情形 0在用 1已让位")
